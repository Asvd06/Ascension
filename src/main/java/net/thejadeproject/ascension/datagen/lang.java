...
public class lang extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("ascension.physiques.thunderforged_body", "Thunderforged Body");
        add("ascension.physiques.thunderforged_body.desc", "Lightning courses through every muscle and tendon of this physique. Its flesh endures violent currents as naturally as ordinary bodies endure the beating of a heart.");
        add("ascension.physiques.thunderforged_body.desc.short", "A body forged by lightning and violent internal currents.");
        add("ascension.physiques.galebound_body", "Galebound Body");
        add("ascension.physiques.galebound_body.desc", "The body is unnaturally light and responsive, its movements guided by subtle currents of wind. Even its breathing seems to follow the rhythm of the open sky.");
        add("ascension.physiques.galebound_body.desc.short", "A light and agile body bound to the wind.");
        add("ascension.physiques.venom_tempered_body", "Venom-Tempered Body");
        add("ascension.physiques.venom_tempered_body.desc", "Poison has seeped into the foundations of this physique without destroying it. Flesh, blood, and bone have adapted to substances that would cripple ordinary cultivators.");
        add("ascension.physiques.venom_tempered_body.desc.short", "A resilient body tempered by countless poisons.");
        add("ascension.physiques.tidal_soul", "Tidal Soul");
        add("ascension.physiques.tidal_soul.desc", "This soul ebbs and flows like an unseen tide. Its spiritual presence can be calm and yielding one moment, then overwhelming the next.");
        add("ascension.physiques.tidal_soul.desc.short", "A fluid soul that moves with the rhythm of water.");
        add("ascension.physiques.mountain_soul", "Mountain Soul");
        add("ascension.physiques.mountain_soul.desc", "The soul possesses the stillness and weight of an ancient mountain. Outside forces struggle to disturb its deeply rooted spiritual foundation.");
        add("ascension.physiques.mountain_soul.desc.short", "A steadfast soul rooted as deeply as a mountain.");
        add("ascension.physiques.verdant_soul", "Verdant Soul");
        add("ascension.physiques.verdant_soul.desc", "Spiritual vitality grows continuously within this soul. Even after suffering damage, its essence reaches outward like new roots seeking fertile earth.");
        add("ascension.physiques.verdant_soul.desc.short", "A flourishing soul filled with persistent vitality.");
        add("ascension.physiques.metalbound_soul", "Metalbound Soul");
        add("ascension.physiques.metalbound_soul.desc", "This soul has a cold, refined structure resembling tempered metal. Its spiritual form is difficult to bend, erode, or scatter.");
        add("ascension.physiques.metalbound_soul.desc.short", "A refined soul with the resilience of tempered metal.");
        add("ascension.physiques.galeborne_soul", "Galeborne Soul");
        add("ascension.physiques.galeborne_soul.desc", "The soul drifts beyond the restrictions that bind ordinary spirits. Thought and spiritual energy move through it with the speed of a sudden gale.");
        add("ascension.physiques.galeborne_soul.desc.short", "A swift and elusive soul carried by the wind.");
        add("ascension.physiques.venomous_soul", "Venomous Soul");
        add("ascension.physiques.venomous_soul.desc", "Toxic spiritual energy has become inseparable from this soul. Its presence carries a subtle corruption capable of contaminating weaker spiritual foundations.");
        add("ascension.physiques.venomous_soul.desc.short", "A poisonous soul steeped in toxic spiritual energy.");
        add("ascension.physiques.axe_hewn_frame", "Axe-Hewn Frame");
        add("ascension.physiques.axe_hewn_frame.desc", "Broad bones and dense muscles give this physique a natural affinity for heavy, decisive movements. Every strike carries the weight of a falling executioner's axe.");
        add("ascension.physiques.axe_hewn_frame.desc.short", "A powerful frame suited to heavy axe techniques.");
        add("ascension.physiques.piercing_spine", "Piercing Spine");
        add("ascension.physiques.piercing_spine.desc", "The spine and limbs of this physique align naturally behind thrusting attacks. Force travels through the body in one unbroken line, concentrating at a single point.");
        add("ascension.physiques.piercing_spine.desc.short", "A precisely aligned body suited to spear techniques.");
        add("ascension.physiques.bladeflow_meridians", "Bladeflow Meridians");
        add("ascension.physiques.bladeflow_meridians.desc", "These meridians guide essence in smooth, sweeping arcs. Their natural circulation mirrors the flowing cuts and continuous momentum of blade cultivation.");
        add("ascension.physiques.bladeflow_meridians.desc.short", "Meridians shaped for flowing blade cultivation.");
        add("ascension.physiques.axeheart_meridians", "Axeheart Meridians");
        add("ascension.physiques.axeheart_meridians.desc", "Essence gathers in dense surges before erupting through these meridians. Their circulation favours overwhelming power rather than restraint or delicate control.");
        add("ascension.physiques.axeheart_meridians.desc.short", "Dense meridians suited to explosive axe cultivation.");
        add("ascension.physiques.iron_fist_meridians", "Iron Fist Meridians");
        add("ascension.physiques.iron_fist_meridians.desc", "The meridians of the arms and hands are exceptionally broad and durable. Essence can be driven directly into close-range strikes without damaging the cultivator.");
        add("ascension.physiques.iron_fist_meridians.desc.short", "Durable meridians made for essence-infused fist techniques.");
        add("ascension.physiques.demon_forged_flesh", "Demon-Forged Flesh");
        add("ascension.physiques.demon_forged_flesh.desc", "Demonic energy has reshaped this physique into something brutally resilient. Its flesh thrives under violent cultivation methods that would ruin an ordinary body.");
        add("ascension.physiques.demon_forged_flesh.desc.short", "A brutal body strengthened by demonic cultivation.");
        ...
        add("ascension.technique.simple_lightning_manual", "Simple Lightning Manual");
        add("ascension.technique.simple_lightning_manual.description.short", "A basic guide to harnessing tiny sparks.");
        add("ascension.technique.simple_lightning_manual.description", "Written on singed parchment, this basic manual teaches a beginner how to safely catch and hold the smallest sparks of static.");
        add("ascension.technique.simple_wind_manual", "Simple Wind Manual");
        add("ascension.technique.simple_wind_manual.description.short", "Learn to step lightly with the breeze.");
        add("ascension.technique.simple_wind_manual.description", "A tattered kite-maker's journal. It contains basic notes on how to feel the changing winds and lighten your footsteps.");
        add("ascension.technique.simple_metal_manual", "Simple Metal Manual");
        add("ascension.technique.simple_metal_manual.description.short", "A blacksmith's daily breathing exercises.");
        add("ascension.technique.simple_metal_manual.description", "Originally passed down among village smiths, these simple instructions teach you how to briefly harden your skin like common iron.");
        add("ascension.technique.simple_wood_manual", "Simple Wood Manual");
        add("ascension.technique.simple_wood_manual.description.short", "Breathe slow and steady, like a growing tree.");
        add("ascension.technique.simple_wood_manual.description", "An old farmer's notes on tending an orchard. It outlines a slow, steady meditation method modeled after a growing sapling.");
        add("ascension.technique.simple_water_manual", "Simple Water Manual");
        add("ascension.technique.simple_water_manual.description.short", "Flow smoothly like a gentle stream.");
        add("ascension.technique.simple_water_manual.description", "Found in a fisherman's tackle box, this soggy booklet describes how to mimic the soft, continuous flow of calm river water.");
        add("ascension.technique.simple_fire_manual", "Simple Fire Manual");
        add("ascension.technique.simple_fire_manual.description.short", "Keep your inner hearth burning bright.");
        add("ascension.technique.simple_fire_manual.description", "A former tavern cook's recipe book. It contains a hidden, basic method for stoking an inner flame to keep warm during winter nights.");
        add("ascension.technique.simple_earth_manual", "Simple Earth Manual");
        add("ascension.technique.simple_earth_manual.description.short", "Stand as firm as the ground beneath you.");
        add("ascension.technique.simple_earth_manual.description", "Carved into a heavy clay tablet, this foundational guide explains how to plant your feet and draw basic stability from the dirt.");
        ...
        add("ascension.skill.elemental_cultivation", "%s Cultivation");
        add("ascension.skill.earth_cultivation.description", "Ground yourself and draw steady, unyielding energy from the dirt and stone beneath you.");
        add("ascension.skill.fire_cultivation.description", "Focus your inner warmth to gather the volatile, flickering energy of nearby flames.");
        add("ascension.skill.lightning_cultivation.description", "Channel the static in the air, pulling quick, sharp sparks of energy into your body.");
        add("ascension.skill.metal_cultivation.description", "Breathe in the sharp, rigid essence of iron and ore to slowly temper your form.");
        add("ascension.skill.water_cultivation.description", "Let your energy flow like a calm river, absorbing the gentle moisture from your surroundings.");
        add("ascension.skill.wind_cultivation.description", "Empty your mind and let the passing breeze carry light, drifting energy into your core.");
        add("ascension.skill.wood_cultivation.description", "Meditate on the slow growth of living things, pulling vital, green energy from nearby flora.");
