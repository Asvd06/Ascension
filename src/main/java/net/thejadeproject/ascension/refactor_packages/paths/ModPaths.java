...
public class ModPaths {
    ...
    public static final DeferredHolder<IPath, ? extends GenericPath> BODY = PATHS.register("body",()->
            new FoundationPath(Component.translatable("ascension.path.body"))
                    ...
                    .addFoundationRequirement(0,9000)
                    .addFoundationRequirement(1,10000)
                    .addFoundationRequirement(2,20000)
                    .addFoundationRequirement(3,30000)
                    .addFoundationRequirement(4,750000)
